...
const AddSemester = ({ setSemesters }: AddSemesterProps) => {
  ...
  const { mutate: addSemester, isPending } =
    api.semesterHoliday.addSemester.useMutation({
      onSuccess: (data) => {
      ...
      onError: (err) => {
        ...
        toast({
          title: "Error",
          description: "An error occurred while adding semester",
          variant: "destructive",
        });
      },
    });
